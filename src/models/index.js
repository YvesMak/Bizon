...
const initModels = () => {
  ...
  SubscriptionPayment.belongsTo(Restaurant, { foreignKey: 'restaurant_id', as: 'restaurant' });
  Restaurant.hasMany(SubscriptionPayment, { foreignKey: 'restaurant_id', as: 'subscriptionPayments' });
